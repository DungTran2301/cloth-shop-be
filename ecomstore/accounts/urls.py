...
from accounts.views import UserRegister, UserLogin, get_user_profile, update_user_profile, logout, UserRegisterWithGoogleAndGoogle, change_password

urlpatterns = [
    path('auth/signup/', UserRegister, name="register"),
    path('auth/login/', UserLogin, name="login"),
    path('auth/login_with_google_and_facebook/', UserRegisterWithGoogleAndGoogle,
