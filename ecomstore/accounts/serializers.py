...
class SignUpSerializer(serializers.ModelSerializer):
    ...
    telephoneNumber = serializers.CharField(max_length=20, default=None)
    deliveryAddress = serializers.CharField(max_length=200, default=None)
    verifyToken = serializers.CharField(max_length=200, default=None, write_only=True)

    class Meta:
        model = User
        fields = ["email", "username", "password", "name", "role",
                  "telephoneNumber", "deliveryAddress", "verifyToken"]
...
class UserProfileSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ["email", "username", "name", "role",
                  "telephoneNumber", "deliveryAddress"]
